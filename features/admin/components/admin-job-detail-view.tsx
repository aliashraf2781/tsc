...
import { formatApplicationDeadline, formatJobSalaryRange, formatPostedLabel, getJobCompanyLogo, resolveJobApplicationDeadline } from "@/features/jobs/lib/job-display"
...
export async function AdminJobDetailView({
  ...
  const deadline = formatApplicationDeadline(resolveJobApplicationDeadline(job), locale)
